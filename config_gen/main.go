...
func main() {
	...
	viperRead.AddConfigPath("./config_gen/")
	...
	ProcessCount := 3 // the number of nodes in other machines
	...
	timeConfig := viperRead.GetInt("timer_config")
	...
	for _, name := range clusterName {
		...
		for j := 0; j < loopCount; j++ {
			...
			viperWrite.Set("timer_config", timeConfig)
